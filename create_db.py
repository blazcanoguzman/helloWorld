...
with app.app_context():
    ...
    # Initial loading of users (included my personal user to the list)
    users = [
        ...
        {'username': 'blazcano', 'email': 'blazcano@umd.edu', 'first_name': 'Brandon', 'last_name': 'Lazcano-Guzman',
         'password': generate_password_hash('blazcano', method='pbkdf2:sha256'), 'role': 'STUDENT'}
       ]
