...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith','email_address':' ', 'major_id':3,
            'birth_date': dt.datetime(2007, 6, 1), 'is_honors':1},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching','email_address':' ', 'major_id':6,
    ...
    for each_student in students:
        ...
        a_student = Student(first_name=each_student["first_name"], last_name=each_student["last_name"],
                            email_address=each_student["email_address"], major_id=each_student["major_id"],
